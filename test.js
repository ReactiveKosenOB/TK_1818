const test = require('./src/templates/MessageTemplates')
a = test.FlexPostMessage.getTemplate({'text' : 'test', 'date': new Date()}).content
console.log(JSON.stringify(a))
// const LINEModule = require('./src/modules/LINEMessage.js')
...
//     const res = await morph.morphological("こんにちはおっぱい")
//     console.log(res)
// }

// // doit()
// const test = require('./src/templates/MessageTemplates').test